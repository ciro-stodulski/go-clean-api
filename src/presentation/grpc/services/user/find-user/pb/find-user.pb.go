...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_find_user_proto_msgTypes[0]
...
func (*User) Descriptor() ([]byte, []int) {
	return file_find_user_proto_rawDescGZIP(), []int{0}
}
...
func (x *NewRequestFindUser) Reset() {
	*x = NewRequestFindUser{}
	if protoimpl.UnsafeEnabled {
		mi := &file_find_user_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NewRequestFindUser) Descriptor() ([]byte, []int) {
	return file_find_user_proto_rawDescGZIP(), []int{1}
}
...
func (x *NewResponseFindUser) Reset() {
	*x = NewResponseFindUser{}
	if protoimpl.UnsafeEnabled {
		mi := &file_find_user_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NewResponseFindUser) Descriptor() ([]byte, []int) {
	return file_find_user_proto_rawDescGZIP(), []int{2}
}
...
var File_find_user_proto protoreflect.FileDescriptor

var file_find_user_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x66, 0x69, 0x6e, 0x64, 0x2d, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x0a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x22, 0x30, 0x0a,
	...
	,
}

var (
	file_find_user_proto_rawDescOnce sync.Once
	file_find_user_proto_rawDescData = file_find_user_proto_rawDesc
)

func file_find_user_proto_rawDescGZIP() []byte {
	file_find_user_proto_rawDescOnce.Do(func() {
		file_find_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_find_user_proto_rawDescData)
	})
	return file_find_user_proto_rawDescData
}

var file_find_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_find_user_proto_goTypes = []interface{}{
...
var file_find_user_proto_depIdxs = []int32{
...
func init() { file_find_user_proto_init() }
func file_find_user_proto_init() {
	if File_find_user_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_find_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_find_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_find_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_find_user_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_find_user_proto_goTypes,
		DependencyIndexes: file_find_user_proto_depIdxs,
		MessageInfos:      file_find_user_proto_msgTypes,
	}.Build()
	File_find_user_proto = out.File
	file_find_user_proto_rawDesc = nil
	file_find_user_proto_goTypes = nil
	file_find_user_proto_depIdxs = nil
}
